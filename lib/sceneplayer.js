...
function ScenePlayer( id ){
    ...
    this.render = function(){
        ...
        //_MANAGER.display.beginPath();
        //_MANAGER.display.rect(0, 0, _MANAGER.canvas.width, _MANAGER.canvas.height);
        //_MANAGER.display.fillStyle = 'rgba(120,200,255,1)';
        //_MANAGER.display.fill();
        
        _MANAGER.display.reset( 120 , 200 , 255 );
        ...
        _MANAGER.gameLoop = window.setInterval( function(){
            ...
            switch( true ){
                case _MANAGER.status > ScenePlayer.Status.Playing:
                    ...
                    _MANAGER.gameLoop = 0;
                    _MANAGER.display.reset(250,250,250);
                    break;
                case _MANAGER.status === ScenePlayer.Status.Playing:
                    //Main game loop
    ...
    this.init = function(){
        ...
        document.addEventListener('DOMContentLoaded',function(e){
            ...
            //console.log(_MANAGER.display);
            _MANAGER.display.reset = function( R,G,B ){

                //window.requestAnimationFrame( this.render );
                // Clear the canvas
                this.clearRect(0,0,_MANAGER.canvas.width,_MANAGER.canvas.height);

                this.beginPath();
                
                this.rect(0, 0, _MANAGER.canvas.width, _MANAGER.canvas.height);
